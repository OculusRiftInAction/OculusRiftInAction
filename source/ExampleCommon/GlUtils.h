...
public:
    ...
    static void drawQuad(const glm::vec2 & min = glm::vec2(-1), const glm::vec2 & max = glm::vec2(1));
    static void drawAngleTicks();
    static void draw3dGrid();
    static GL::VertexBufferPtr getQuadVertices();
    static GL::IndexBufferPtr getQuadIndices();

    static GL::VertexBufferPtr getCubeVertices();
    static GL::IndexBufferPtr getCubeIndices();
    static GL::IndexBufferPtr getCubeWireIndices();

    static void renderMesh(Resource meshName, Resource shaderName = Resource::SHADERS_LIT_VS);
    static void renderBunny(Resource shaderName = Resource::SHADERS_LIT_VS);
    static void renderArtificialHorizon(Resource shaderName = Resource::SHADERS_LIT_VS);

    static void renderString(const Text::FontPtr & font, const std::string & str, glm::vec2 & cursor, float fontSize = 12.0f);
    static void renderString(const Text::FontPtr & font, const std::wstring & str, glm::vec2 & cursor, float fontSize = 12.0f);
    static void renderString(const Text::FontPtr & font, const std::string & str, float fontSize = 12.0f);
    static void renderString(const Text::FontPtr & font, const std::wstring & str, float fontSize = 12.0f);
    static rectf measure(const Text::FontPtr & font, const std::string &text, float fontSize);
    static float measureWidth(const Text::FontPtr & font, const std::string &text, float fontSize, bool precise);
