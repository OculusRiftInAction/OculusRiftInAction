...
public class RiftDemo extends LwjglApp {
  ...
  protected void initGl() {
    ...
    distortProgram = new Program(ExampleResource.SHADERS_SIMPLETEXTURED_VS,
        ExampleResource.SHADERS_TEXTURE_FS);
    distortProgram.link();
    renderProgram = new Program(ExampleResource.SHADERS_SIMPLECOLORED_VS,
